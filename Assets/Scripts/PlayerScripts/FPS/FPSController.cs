...
public class FPSController : MonoBehaviour
{
	...
	public void CheckIfWallInFront()
	{
		...
		RaycastHit hit;
		Vector3 rayStart = new Vector3(this.transform.position.x, this.transform.position.y+2, this.transform.position.z);
		Vector3 direction = this.transform.forward * 3;



		Debug.DrawLine(rayStart, direction, Color.red ,4);

		if (Physics.Raycast(rayStart, direction,out hit, 4 ))
        {
			//print("Did hit");
            ...
            {
				this.transform.Rotate(transform.up * 90);
				print("Hit!");
            }
            else
            {
